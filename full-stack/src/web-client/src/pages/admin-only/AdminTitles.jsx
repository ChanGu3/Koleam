                ...
                <div className="flex flex-col justify-start my-4 w-full">
                    ...
                    <div className="flex flex-row itemscenter gap-4 w-full">
                        {isSelect ? (
                            ...
                            >
                                <option
                                    className="bg-os-blue-secondary/40 text-os-white font-bold"
                                    value={``}
                                    disabled
                                >
                                    Select {titleName}
                                ...
                                {availableOptionsList
                                    ? availableOptionsList.map((avOp) => {
                                          return (
                                              <option
                                                  key={avOp[variableNameToAccess]}
                                                  value={avOp[variableNameToAccess]}
                    ...
                    {currentChosenOptionsList ? (
                        <div className="grid grid-flow-rows grid-cols-3 gap-2">
                            {currentChosenOptionsList.map((currOp) => {
                                return (
                                    <div
                                        key={currOp[variableNameToAccess]}
                                        className="flex flex-row bg-os-blue-primary px-0.5 py-1.5 rounded-md w-32 max-w-32"
                                    >
                                        <button
                                            type="button"
                                            onClick={() => {
...
function ConfirmDelete({ onClose, editAnimeData }) {
    ...
    return (
        ...
        >
            <div
                className="admin-anime-modal ring-1"
                        ...
                        <div className="admin-anime-modal-section">
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    defaultValue={editAnimeData ? editAnimeData.anime.title : ""}
                                />
                            </label>
                            <label>
                                Description:
                                <textarea
                                    ...
                                    defaultValue={editAnimeData ? editAnimeData.anime.description : ""}
                                />
                            </label>
                            <label>
                                Copyright:
                                <input
                                    ...
                                    defaultValue={editAnimeData ? editAnimeData.anime.copyright : ""}
                                />
                            </label>
                            <label>
                            ...
                            <label>
                                ...
                                <img
                                    ...
                                    className="aspect-video w-64 rounded-sm ring-3 ring-os-dark-tertiary m-1"
                                ></img>{" "}
                            </label>
                        </div>
                        ...
                        <div className="admin-anime-modal-section">
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    defaultValue={editAnimeData ? editAnimeData.stream.title : ""}
                                />
                            </label>
                            <label>
                                Synopsis:
                                <textarea
                                    ...
                                    defaultValue={editAnimeData ? editAnimeData.stream.synopsis : ""}
                                />
                            </label>
                            <label>
                                Release Date:
                                <input
                                    name="streamReleaseDate"
                                    type="date"
                                    defaultValue={editAnimeData ? editAnimeData.stream.releaseDate.split("T")[0] : ""}
                                />
                            </label>
                            <label>
                                {editAnimeData ? "Upload New" : ""} Cover File:
    ...
    return (
        <>
            <div className="admin-anime-container">
                <h2>Anime Movies</h2>
                <button
                    className="admin-anime-upload-btn"
                        ...
                        <tbody>
                            {animeList.map((a, i) => (
                                <tr key={i}>
                                    ...
                                    <td>
                                        <a
                                            className="hover:text-os-blue-tertiary"
                                            href={`/stream/${a.id}/${a.title}`}
                                        >
                                            {a.title}
                                        </a>
                                    </td>
            ...
            <div className="fixed bottom-12 left-12">
                <ButtonUI
                    className="px-8 py-4 rounded-md inset-shadow-sm inset-shadow-s-dark-tertiary"
                    label={
