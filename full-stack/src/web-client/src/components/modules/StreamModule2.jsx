            ...
            <div className="relative">
                ...
                >
                    ...
                    <div className={`flex flex-col ${flipBottomText ? "md:flex-row-reverse" : "md:flex-row"} justify-between `}>
                        <p className="font-semibold text-xs md:text-md text-s-white group-active:underline group-hover:underline truncate">
                            {streamInfo}
                        </p>
                        <p className="text-s-dark-secondary text-[6px] md:text-[8px] italic font-semibold whitespace-nowrap flex flex-col">
                            ...
                            {installmentTitle && (
                                <span className={`w-full ${flipBottomText ? "text-start" : "text-end"}`}>{installmentTitle}</span>
                            )}
                        </p>
                    </div>
                </Link>
